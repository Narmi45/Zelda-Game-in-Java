//Name: Imran Khan
//Date: 2/18/2022
//Assignment Description: In this assignment, I created a Map Editor that allows users to create and delete bricks, as well as change the view of the room.
//						  I created bricks by using my left click and created functionality so that when I clicked bricks that were already placed, I would
//						  delete them instead. I created 4 rooms, and you can use W, A, D, and X as arrow keys to shift the view from 1 room to the other.
